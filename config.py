...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7715134650:AAGbe-z3CsIenILzU6ArEEq1jKrkG7ex80g")
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://sakshamranjan7:8wBCaYilCTlgdNV3@cluster0.h184m7m.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002724807483"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002828032181"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002322536072"))
FORCE_SUB_CHANNEL4 = int(os.environ.get("FORCE_SUB_CHANNEL4", "-1002595392410"))
...
try:
    ADMINS=[6848088376]
    for x in (os.environ.get("ADMINS", "8002803133").split()):
        ADMINS.append(int(x))
except ValueError:
